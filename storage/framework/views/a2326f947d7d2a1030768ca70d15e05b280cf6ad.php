...
<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
    ...
    <div class="collapse navbar-collapse" id="menu">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <?php endif; ?>
            <li class="nav-item">
                <a class="nav-link" href="<?php echo e(route("soporte.index")); ?>">Soporte&nbsp;<i
                        class="fa fa-hands-helping"></i></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?php echo e(route("acerca_de.index")); ?>">Acerca de&nbsp;<i class="fa fa-info"></i></a>
            </li>
        </ul>
    </div>
</nav>
...
<?php /**PATH C:\Users\miaxh\laravel\Almacen_Ixtlahuaca\resources\views/maestra.blade.php ENDPATH**/ ?>